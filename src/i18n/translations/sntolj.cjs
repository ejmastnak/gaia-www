    ...
    list: [
      {
        ...
        sl: "pomirjanje živčnih bolečin,",
      },
      {
        en: "Relief of aching joints",
        sl: "blažitev bolečin v sklepih,",
      },
      {
        en: "Healing of burns, scrapes, and bruises",
        sl: "celjenje opeklin, odrgnin in podplutb,",
      },
      {
        en: "Improved circulation at the skin surface",
        sl: "izboljšanje prekrvavitve kožne povrhnjice.",
      },
    ],
    footer: {
